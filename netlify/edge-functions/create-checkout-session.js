...
function getPriceCodeForRegion(region) {
  switch (region) {
    case 'US': return process.env.US_PRICE_CODE;
    case 'BR': return process.env.BR_PRICE_CODE;
    case 'EU': return process.env.EU_PRICE_CODE;
    default: return process.env.US_PRICE_CODE;
  }
}
